...
const hasilNgopi = sudahNgopi
  ? console.log("Sudah Ngopi")
  : sudahMakan
  ? console.log("Sudah Makan")
  : console.log("Belum Ngopi & Belum Makan");
